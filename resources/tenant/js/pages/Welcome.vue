...
const tenantName = computed(() => page.props.tenant)
</script>
...
<template>
    ...
    <div class="flex h-screen w-full items-center justify-center bg-black text-white">
        <div class="text-center">
            ...
            <h1 class="font-serif font-bold mt-1 text-xl text-primary-400 tracking-widest lg:text-3xl">Tenant: {{ tenantName }} </h1>
        </div>
